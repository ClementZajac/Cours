...
% Essai de modification pour supprimer warning
% Mais il y a un probleme d'affichage sous windd
...
CHOICEHANDLES(matchn)=figure('Position',rect,'number','off','name','','resize','off','colormap',[],'NextPlot','new');
%CHOICEHANDLES(matchn) = figure('Units',norm,'Position',rect,'number','off', %'name','','resize','on','colormap',[],'HandleVisibility','off');
%CHOICEHANDLES(matchn) = figure('Units',norm,rectnorm,'number','off','name','','colormap',[],'HandleVisibility','off');
